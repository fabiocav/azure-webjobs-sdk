...
//            // Act
//            IAsyncResult result = product.CommitAsync();
...
//            innerStreamMock.Setup(s => s.CommitAsync()).Callback(() => committed = true);
//            CloudBlobStream innerStream = innerStreamMock.Object;
//            CloudBlobStream product = CreateProductUnderTest(innerStream);
...
//            innerStreamMock.Setup(s => s.CommitAsync()).Callback(() => commitCalls++).Throws(expectedException);
//            CloudBlobStream innerStream = innerStreamMock.Object;
//            CloudBlobStream product = CreateProductUnderTest(innerStream);
...
//        [Fact]
//        public async Task Close_WhenInnerStreamBeginCommitThrewOnPreviousBeginCommit_DoesNotTryToCommitAgain()
//        {
//            // Arrange
//            int commitCalls = 0;
//            Mock<CloudBlobStream> innerStreamMock = CreateMockInnerStream();
